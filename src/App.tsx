...
export default function App() {
  ...
  useEffect(() => {
    ...
    void (async () => {
      const { ensureVaultSystemPrompt, ensureVaultVoicePrompt, ensureVaultTelegramPrompt, ensureVaultSupervisorPrompt, ensureVaultAssistantPrompt } = await import("./meta");
